...
function HotBuildSettingsViewModel()
{
    ...
    self.buildings = ko.observableArray([
                                         ...
                                         { displayname: "Umbrella", json: "/pa/units/orbital/ion_defense/ion_defense.json" },
                                         { displayname: "Jelly Fish", json: "/pa/units/sea/sea_mine/sea_mine.json" },
                                         { displayname: "Sonar", json: "/pa/units/sea/sonar/sonar.json" },
                                         { displayname: "Torpedo Launcher", json: "/pa/units/sea/torpedo_launcher/torpedo_launcher.json" },
                                         { displayname: "Advanced Torpedo Launcher", json: "/pa/units/sea/torpedo_launcher_adv/torpedo_launcher_adv.json" },
